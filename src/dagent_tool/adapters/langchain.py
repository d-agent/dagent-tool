...
try:
    ...
    raise ImportError(
        ...
        "Install it with: pip install dagent-tool[langchain]"
    )

@tool
async def langchain_tool(requirements: Requirement, text: str, is_new_session: bool = False):
    """
